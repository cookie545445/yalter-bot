...
impl<'a> module::Module for Module<'a> {
    ...
    fn command_description(&self, id: u32) -> &'static str {
        match id {
            x if x == Commands::Modules as u32 => "Information about modules.",
            x if x == Commands::Commands as u32 => "Lists all available commands.",
            x if x == Commands::Command as u32 => "Gets information about the specified command.",
    ...
    fn command_help_message(&self, id: u32) -> &'static str {
        match id {
            ...
            x if x == Commands::Commands as u32 => "`!commands` - lists all available commands.",
            x if x == Commands::Command as u32 => "`!help <command>` - gets information about the specified command.",
    ...
    fn handle(&self, bot: &Bot, message: &Message, id: u32, text: &str) {
        match id {
            x if x == Commands::Modules as u32 => self.handle_modules(bot, message, text),
            x if x == Commands::Commands as u32 => self.handle_commands(bot, message, text),
            x if x == Commands::Command as u32 => self.handle_command(bot, message, text),
